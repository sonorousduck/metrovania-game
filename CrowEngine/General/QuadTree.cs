        ...
        public bool[] GetQuadrants(GameObject obj)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                if (rectangleCollider == null)
                {
                    ...
                    if (transform.position.X + circleCollider.offset.X < children[i].position.X)
                    {
                        testLocation.X = children[i].position.X;
                    }
                    else if (transform.position.X + circleCollider.offset.X > children[i].position.X + children[i].size.X)
                    {
                        testLocation.X = children[i].position.X + children[i].size.X;
                    }

                    if (transform.position.Y + circleCollider.offset.Y < children[i].position.Y)
                    {
                        testLocation.Y = children[i].position.Y;
                    }
                    else if (transform.position.Y + circleCollider.offset.Y > children[i].position.Y + children[i].size.Y)
                    {
                        testLocation.Y = children[i].position.Y + children[i].size.Y;
                    }

                    float squaredDistance = Vector2.DistanceSquared(transform.position + circleCollider.offset, testLocation);
                ...
                else
                {
                    ...
                    if (!(
                        (transform.position.X + rectangleCollider.offset.X) - rectangleCollider.size.X / 2f > children[i].position.X + children[i].size.X ||
                        (transform.position.X + rectangleCollider.offset.X) + rectangleCollider.size.X / 2f < children[i].position.X ||
                        (transform.position.Y + rectangleCollider.offset.Y) - rectangleCollider.size.Y / 2f > children[i].position.Y + children[i].size.Y ||
                        (transform.position.Y + rectangleCollider.offset.Y) + rectangleCollider.size.Y / 2f < children[i].position.Y
                        ))
                    {
                        quadrants[i] = true;
                    }
